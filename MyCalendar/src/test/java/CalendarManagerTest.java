...
class CalendarManagerTest {
    ...
    private static final LocalDateTime TIME = LocalDateTime.of(2026, 6, 15, 9, 0); // gardé pour tester eventsDansPeriode
    ...
    void rdvPersonnelCommenceParRDV() {
        Event e = new RdvPersonnel(new TitreEvenement("Dentiste"), new ProprietaireEvenement("Léo"), DATE, HEURE, 30);
    ...
    void reunionContientTitreLieuEtParticipants() {
        Event e = new Reunion(new TitreEvenement("Sprint"), new ProprietaireEvenement("Léo"), DATE, HEURE, 60, "Salle B", "Léo, Ilan");
    ...
    void periodiqueMentionneFrequenceEtTitre() {
        Event e = new Periodique(new TitreEvenement("Stand-up"), new ProprietaireEvenement("Léo"), DATE, HEURE, 0, 7);
    ...
    void ajouterUnEvenementIncrementeLaListe() {
        calendar.ajouterEvent(new RdvPersonnel(new TitreEvenement("Coiffeur"), new ProprietaireEvenement("Léo"), DATE, HEURE, 45));
    ...
    void ajouterPlusieursEvenements() {
        calendar.ajouterEvent(new RdvPersonnel(new TitreEvenement("Coiffeur"), new ProprietaireEvenement("Léo"), DATE, HEURE, 45));
        calendar.ajouterEvent(new Reunion(new TitreEvenement("Revue"), new ProprietaireEvenement("Léo"), DATE, new HeureDebut(HEURE.valeur().plusHours(2)), 60, "Salle A", "Léo"));
        calendar.ajouterEvent(new Periodique(new TitreEvenement("Stand-up"), new ProprietaireEvenement("Léo"), new DateEvenement(DATE.valeur().plusDays(1)), HEURE, 0, 1));
        assertEquals(3, calendar.events.size());
    }

    @Test
    void evenementAjouteConserveSesDonnees() {
        calendar.ajouterEvent(new Reunion(new TitreEvenement("Démo"), new ProprietaireEvenement("Ilan"), DATE, HEURE, 90, "Salle C", "Ilan, Noah"));
    ...
    void evenementDansLaPeriodeEstRetourne() {
        calendar.ajouterEvent(new RdvPersonnel(new TitreEvenement("Médecin"), new ProprietaireEvenement("Léo"), DATE, HEURE, 30));
    ...
    void evenementPeriodiqueApparaitSiUneOccurrenceTombeDansLaPeriode() {
        calendar.ajouterEvent(new Periodique(new TitreEvenement("Hebdo"), new ProprietaireEvenement("Léo"), DATE, HEURE, 0, 7));
    ...
    void deuxEvenementsQuiSeChevauchentSontEnConflit() {
        Event e1 = new RdvPersonnel(new TitreEvenement("A"), new ProprietaireEvenement("Léo"), DATE, HEURE, 60);
        Event e2 = new RdvPersonnel(new TitreEvenement("B"), new ProprietaireEvenement("Léo"), DATE, new HeureDebut(HEURE.valeur().plusMinutes(30)), 60);
    ...
    void deuxEvenementsDisjointsSontSansConflit() {
        Event e1 = new RdvPersonnel(new TitreEvenement("A"), new ProprietaireEvenement("Léo"), DATE, HEURE, 60);
        Event e2 = new RdvPersonnel(new TitreEvenement("B"), new ProprietaireEvenement("Léo"), DATE, new HeureDebut(HEURE.valeur().plusHours(2)), 60);
    ...
    void deuxEvenementsAdjacentsSontSansConflit() {
        Event e1 = new RdvPersonnel(new TitreEvenement("A"), new ProprietaireEvenement("Léo"), DATE, HEURE, 60);
        Event e2 = new RdvPersonnel(new TitreEvenement("B"), new ProprietaireEvenement("Léo"), DATE, new HeureDebut(HEURE.valeur().plusHours(1)), 60);
        assertFalse(calendar.conflit(e1, e2));
    }
    ...
    void conflitImpliquantUnPeriodiqueToujoursRetourneFalse() {
        Event e1 = new RdvPersonnel(new TitreEvenement("A"), new ProprietaireEvenement("Léo"), DATE, HEURE, 60);
        Event e2 = new Periodique(new TitreEvenement("Hebdo"), new ProprietaireEvenement("Léo"), DATE, HEURE, 0, 7);
        assertFalse(calendar.conflit(e1, e2));
