...
class CalendarManagerTest {
    ...
    void rdvPersonnelCommenceParRDV() {
        Event e = new RdvPersonnel(new TitreEvenement("Dentiste"), "Léo", TIME, 30);
    ...
    void reunionContientTitreLieuEtParticipants() {
        Event e = new Reunion(new TitreEvenement("Sprint"), "Léo", TIME, 60, "Salle B", "Léo, Ilan");
    ...
    void periodiqueMentionneFrequenceEtTitre() {
        Event e = new Periodique(new TitreEvenement("Stand-up"), "Léo", TIME, 0, 7);
    ...
    void ajouterUnEvenementIncrementeLaListe() {
        calendar.ajouterEvent(new RdvPersonnel(new TitreEvenement("Coiffeur"), "Léo", TIME, 45));
    ...
    void ajouterPlusieursEvenements() {
        calendar.ajouterEvent(new RdvPersonnel(new TitreEvenement("Coiffeur"), "Léo", TIME, 45));
        calendar.ajouterEvent(new Reunion(new TitreEvenement("Revue"), "Léo", TIME.plusHours(2), 60, "Salle A", "Léo"));
        calendar.ajouterEvent(new Periodique(new TitreEvenement("Stand-up"), "Léo", TIME.plusDays(1), 0, 1));
        assertEquals(3, calendar.events.size());
    }

    @Test
    void evenementAjouteConserveSesDonnees() {
        calendar.ajouterEvent(new Reunion(new TitreEvenement("Démo"), "Ilan", TIME, 90, "Salle C", "Ilan, Noah"));
    ...
    void evenementDansLaPeriodeEstRetourne() {
        calendar.ajouterEvent(new RdvPersonnel(new TitreEvenement("Médecin"), "Léo", TIME, 30));
    ...
    void evenementPeriodiqueApparaitSiUneOccurrenceTombeDansLaPeriode() {
        ...
        calendar.ajouterEvent(new Periodique(new TitreEvenement("Hebdo"), "Léo", TIME, 0, 7));
    ...
    void deuxEvenementsQuiSeChevauchentSontEnConflit() {
        Event e1 = new RdvPersonnel(new TitreEvenement("A"), "Léo", TIME, 60);
        Event e2 = new RdvPersonnel(new TitreEvenement("B"), "Léo", TIME.plusMinutes(30), 60);
    ...
    void deuxEvenementsDisjointsSontSansConflit() {
        Event e1 = new RdvPersonnel(new TitreEvenement("A"), "Léo", TIME, 60);
        Event e2 = new RdvPersonnel(new TitreEvenement("B"), "Léo", TIME.plusHours(2), 60);
    ...
    void deuxEvenementsAdjacentsSontSansConflit() {
        Event e1 = new RdvPersonnel(new TitreEvenement("A"), "Léo", TIME, 60);
        Event e2 = new RdvPersonnel(new TitreEvenement("B"), "Léo", TIME.plusHours(1), 60);
        assertFalse(calendar.conflit(e1, e2));
    }
    ...
    void conflitImpliquantUnPeriodiqueToujoursRetourneFalse() {
        Event e1 = new RdvPersonnel(new TitreEvenement("A"), "Léo", TIME, 60);
        Event e2 = new Periodique(new TitreEvenement("Hebdo"), "Léo", TIME, 0, 7);
        assertFalse(calendar.conflit(e1, e2));
